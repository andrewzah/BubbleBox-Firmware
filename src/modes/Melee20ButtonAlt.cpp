...
Melee20ButtonAlt::Melee20ButtonAlt(socd::SocdType socd_type, Melee20ButtonAltOptions options)
...
void Melee20ButtonAlt::HandleSocd(InputState &inputs) {
    _horizontal_socd = inputs.left && inputs.right;
    InputMode::HandleSocd(inputs);
}

void Melee20ButtonAlt::UpdateDigitalOutputs(InputState &inputs, OutputState &outputs) {
    outputs.a = inputs.a;
    outputs.b = inputs.b;
    outputs.x = inputs.x;
    outputs.y = inputs.y;
...
void Melee20ButtonAlt::UpdateAnalogOutputs(InputState &inputs, OutputState &outputs) {
